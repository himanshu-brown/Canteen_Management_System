<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">Canteen Meal Manager</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/Canteen_Project" class="hvr-grow">Home</a></li>
		        <li><a href="/Canteen_Project/about-canteen.php" class="hvr-grow">About Us</a></li>
